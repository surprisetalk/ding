...
(303, 0301, 202, 'Bugs love weekends too!', '{}'),
...
(306, 0304, 205, 'Only when I finally solve that pesky bug.', '{}'),
(307, null, 206, 'Semicolon misplaced. It’s a tragedy.', '{humor, syntax}'),
(308, 0307, 203, 'I feel your pain, syntax samurai.', '{}'),
(309, null, 205, 'Breakpoints are like checkpoints in life.', '{motivation, debugging}'),
(310, 0309, 201, 'And stepping through code is like meditation.', '{}'),
(311, null, 201, 'Just found a bug that only occurs on leap years. FML.', '{humor, bugs}'),
(312, 0311, 202, 'Those are the best kind. Totally worth the wait.', '{}'),
...
(315, 0314, 206, 'Teach me your ways, CodeWarrior007!', '{}'),
(316, null, 204, 'Just saw someone use a global variable... in 2024. Cringe.', '{humor, coding}'),
(317, 0316, 205, 'Yikes. That’s a crime against programming.', '{}'),
(318, null, 205, 'Spent 3 hours debugging only to find out I misspelled a variable. Classic.', '{humor, debugging}'),
(319, 0318, 203, 'Been there, done that. Welcome to the club.', '{}'),
(320, null, 206, 'Autocomplete is both a blessing and a curse.', '{humor, coding}'),
(321, 0320, 201, 'True, but more blessing when it actually works.', '{}'),
(322, null, 201, 'Why does every tutorial say “it’s simple” and then proceed to confuse you for hours?', '{humor, learning}'),
(323, 0322, 204, 'Because they are written by people who forgot how hard it is to learn from scratch.', '{}'),
(324, null, 202, 'My code works. I have no idea why. But it works.', '{humor, coding}'),
(325, 0324, 203, 'If it ain’t broke, don’t fix it.', '{}'),
(326, null, 204, 'Just spent 2 hours fixing a bug that turned out to be a typo.', '{humor, debugging}'),
(327, 0326, 202, 'Typos: the silent killers.', '{}'),
(328, null, 205, 'Breakpoints are my best friends.', '{humor, debugging}'),
(329, 0328, 201, 'Especially when you’re deep into spaghetti code.', '{}'),
(330, null, 206, 'Why do code reviews feel like therapy sessions?', '{humor, coding}'),
(331, 0330, 205, 'Because they are! Code is personal.', '{}'),
(332, null, 203, 'Just finished a project without any merge conflicts. Feels like winning the lottery.', '{motivation, coding}'),
(333, 0332, 204, 'You should definitely buy a lottery ticket today.', '{}'),
(334, 0311, 203, 'Leap year bugs are like finding Easter eggs... painful ones.', '{}'),
(335, 0313, 204, 'More panic and less cake, unfortunately.', '{}'),
(336, 0313, 201, 'Segfaults: the ultimate surprise gift from your code.', '{}'),
(337, 0314, 202, 'That’s some next-level optimization. Hats off!', '{}'),
(338, 0314, 204, 'O(n log n)? You must have used some dark magic.', '{}'),
(339, 0316, 201, 'Global variables are so last century.', '{}'),
(340, 0318, 206, 'Nothing like a good variable name typo to humble you.', '{}'),
(341, 0318, 204, 'Variable typos: the bane of every coder’s existence.', '{}'),
(342, 0320, 202, 'Autocomplete is the friend who tries too hard.', '{}'),
(343, 0320, 205, 'And sometimes, it’s that annoying friend who finishes your sentences wrong.', '{}'),
(344, 0322, 203, 'It’s their way of saying "Welcome to the real world."', '{}'),
(345, 0322, 206, 'Because simplicity is a complex concept.', '{}'),
(346, 0324, 201, 'The mystery of working code: embrace it.', '{}'),
(347, 0324, 204, 'Sometimes code just wants to be mysterious.', '{}'),
(348, 0326, 205, 'Typo bugs: 1, Human: 0.', '{}'),
(349, 0328, 202, 'Breakpoints are the unsung heroes of debugging.', '{}'),
(350, 0328, 203, 'Breakpoints and coffee: the ultimate combo.', '{}'),
(351, 0330, 201, 'Because they reveal your deepest coding secrets.', '{}'),
(352, 0330, 204, 'It’s a safe space to discuss your code crimes.', '{}'),
(353, 0332, 202, 'Merge conflicts are the worst. Congrats on avoiding them!', '{}'),
(354, 0332, 205, 'That’s a rare achievement! Celebrate it.', '{}');
