...
const PROBLEMS = [
  {
    title: "FizzBuzz Sum",
    body: "Find the sum of all numbers below 1000 that are divisible by 3 or 5.\n\nExample: Below 10, the answer is 23 (3+5+6+9).",
    difficulty: "easy",
  },
  {
    title: "Collatz Length",
    body: "Find the starting number under 1,000,000 that produces the longest Collatz sequence.\n\nRules: if n is even, n→n/2; if odd, n→3n+1. Stop at 1.",
    difficulty: "medium",
  },
  {
    title: "Palindrome Product",
    body: "Find the largest palindrome made from the product of two 3-digit numbers.\n\nExample: 99 × 91 = 9009, the largest palindrome from two 2-digit numbers.",
    difficulty: "easy",
  },
  {
    title: "Triangle Numbers",
    body: "What is the first triangle number to have over 500 divisors?\n\nTriangle numbers: 1, 3, 6, 10, 15, 21, ... (the nth is n(n+1)/2).",
    difficulty: "medium",
  },
  {
    title: "Letter Frequency",
    body: "Write the shortest program that reads stdin and prints each unique letter (a-z, case-insensitive) with its count, sorted by frequency descending.\n\nExample: \"hello\" → l:2 h:1 e:1 o:1",
    difficulty: "easy",
  },
  {
    title: "Roman Numerals",
    body: "Write the shortest function that converts an integer (1-3999) to a Roman numeral string.\n\nExamples: 4→IV, 9→IX, 58→LVIII, 1994→MCMXCIV",
    difficulty: "easy",
  },
  {
    title: "Balanced Brackets",
    body: "Write the shortest program that checks if a string of brackets ()[]\\{\\} is balanced.\n\nExamples: \"([])\" → true, \"([)]\" → false, \"\" → true",
    difficulty: "easy",
  },
  {
    title: "Prime Spiral",
    body: "Print an Ulam spiral of size 9×9 to stdout. Mark primes with # and composites with .\n\nThe spiral starts at center with 1 and winds outward counterclockwise.",
    difficulty: "hard",
  },
  {
  ...
  },
  {
    ...
    body: "Find the sum of all numbers that can be written as the sum of fifth powers of their digits.\n\nExample: 1634 = 1⁴ + 6⁴ + 3⁴ + 4⁴ (but with 5th powers).",
    difficulty: "medium",
  },
  {
    title: "ROT13",
    body: "Write the shortest ROT13 encoder/decoder. It should read stdin and write the ROT13'd text to stdout.\n\nOnly rotate a-z and A-Z, leave everything else unchanged.",
    difficulty: "easy",
  },
  {
    title: "Matrix Rotation",
    body: "Write the shortest function that rotates an NxN matrix 90° clockwise in-place.\n\nExample: [[1,2],[3,4]] → [[3,1],[4,2]]",
    difficulty: "medium",
  },
  {
    title: "Look and Say",
    body: "Generate the first 10 terms of the look-and-say sequence.\n\n1, 11, 21, 1211, 111221, ...\n\nEach term describes the previous: \"one 1\" → 11, \"two 1s\" → 21.",
    difficulty: "easy",
  },
  {
  ...
  {
    title: "Game of Life",
    body: "Implement one step of Conway's Game of Life on a 20×20 grid. Read the grid from stdin (# = alive, . = dead), print the next generation.\n\nRules: alive with 2-3 neighbors survives; dead with exactly 3 neighbors is born.",
    difficulty: "hard",
  },
  {
  ...
  },
  {
    ...
    body: "Find the sum of all amicable numbers under 10000.\n\nTwo numbers are amicable if d(a)=b and d(b)=a where d(n) is the sum of proper divisors of n, and a≠b.",
    difficulty: "medium",
  },
  {
    title: "Spiral Matrix",
    body: "Write the shortest function that takes N and returns an N×N matrix filled with numbers 1 to N² in spiral order.\n\nExample N=3:\n1 2 3\n8 9 4\n7 6 5",
    difficulty: "medium",
  },
  {
    title: "Caesar Cipher",
    body: "Write the shortest program that encrypts stdin with a Caesar cipher of shift 13 (same as ROT13 but also shift digits 0-9 by 5).\n\nExample: \"Hello 123\" → \"Uryyb 678\"",
    difficulty: "easy",
  },
  {
    title: "Morse Code",
    body: "Write the shortest program that converts stdin (A-Z, 0-9, space) to Morse code.\n\nUse . and - with spaces between letters and / between words.",
    difficulty: "medium",
  },
  {
  ...
  },
  {
    ...
    body: "Write the shortest function that converts an integer (0-999999) to English words.\n\nExample: 42 → \"forty two\", 1001 → \"one thousand one\"",
    difficulty: "hard",
  },
  {
    title: "Luhn Check",
    body: "Write the shortest function that validates a credit card number using the Luhn algorithm.\n\nExample: 4539578763621486 → true, 1234567890123456 → false",
    difficulty: "easy",
  },
  {
    title: "Abundant Numbers",
    body: "Find the smallest number that cannot be written as the sum of two abundant numbers.\n\nA number is abundant if the sum of its proper divisors exceeds it.",
    difficulty: "hard",
  },
  {
    title: "Permutation Index",
    body: "What is the millionth lexicographic permutation of the digits 0123456789?\n\nDon't brute-force — use the factorial number system.",
    difficulty: "medium",
  },
  {
    title: "Champernowne",
    body: "Find d₁ × d₁₀ × d₁₀₀ × d₁₀₀₀ × d₁₀₀₀₀ × d₁₀₀₀₀₀ × d₁₀₀₀₀₀₀ of Champernowne's constant.\n\n0.123456789101112131415...",
    difficulty: "medium",
  },
  {
    title: "Brainf**k Interpreter",
    body: "Write the shortest Brainf**k interpreter. Read program from first line of stdin, input from second line.\n\nOps: > < + - . , [ ]",
    difficulty: "hard",
  },
  {
    title: "Quine",
    body: "Write the shortest quine in your language of choice.\n\nA quine is a program that outputs its own source code, with no input.",
    difficulty: "hard",
  },
  {
